...
export const styles = StyleSheet.create({
  ...
  cardTitle: { ...typography.semiBold, color: colors.text, fontSize: 17 },
  address: { ...typography.regular, color: colors.textSecondary, fontSize: 13, marginTop: 5 },
  price: { ...typography.medium, color: colors.primary, fontSize: 15, marginTop: 10 },
  actions: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", marginTop: 14 },
  activeLabel: { ...typography.medium, color: colors.textSecondary, fontSize: 13, marginRight: 8 },
  switchRow: { alignItems: "center", flexDirection: "row" },
  editButton: { borderColor: colors.primary, borderRadius: 9, borderWidth: 1, paddingHorizontal: 15, paddingVertical: 8 },
